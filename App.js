...
function MyTabs() {
  return (
    ...
    <Tab.Navigator>
      ...
      <Tab.Screen name="Settings" component={RoomsScreen}
      options={{
    ...
    <Provider theme={theme}>
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen name="Connect" component={ConnectSensor}></Stack.Screen>
          <Stack.Screen name='MotorControllerDetails' component={MotorControllerDetails}></Stack.Screen>
          <Stack.Screen
